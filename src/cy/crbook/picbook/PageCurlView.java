 ...
 *
 */
public abstract class PageCurlView extends View {
	
	public static final int PREV_PAGE=0;
	public static final int NEXT_PAGE=1;
	public static final int BOTH_PAGE=2;
	public static final int NONE_PAGE=3;
	...
	// my hook begin
	*///////////////////
	public void setUpCurrent(Bitmap current){
		this.currentBG=current;
		this.mForeground=current;
	}
	
	public void setUpNext(Bitmap next){
		this.nextBG=next;
	}
	
	public void setUpPrev(Bitmap prev){
		this.prevBG=prev;
	}
	
	public abstract void turnPage(int direction);
	...
	*///////////////////
	...
	private void nextView() {
		setViews(this.currentBG, this.nextBG);
	}
	...
	private void previousView() {
		setViews(this.prevBG, this.currentBG);
	}
	 ...
	 */
	private void setViews(Bitmap fore, Bitmap back) {
		mForeground = fore;
		mBackground = back;
	}
