...
import cy.crbook.widget.ColorCircle;
import cy.crbook.widget.ColorSlider;
import cy.crbook.widget.OnColorChangedListener;
import cy.readall.R;
...
public class ColorPickerActivity extends Activity 
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (state != null) {
        	...
        	color = mIntent.getIntExtra(CRBookIntents.EXTRA_COLOR, Color.BLACK);
        }
	...
	public void onColorPicked(View view, int newColor) {
		...
		mIntent.putExtra(CRBookIntents.EXTRA_COLOR, newColor);
